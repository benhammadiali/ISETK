...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'userapp', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\TestBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity')));
        ...
        $d->addDriver($b, 'TestBundle\\Entity');
        $d->addDriver($b, 'UserBundle\\Entity');
        $d->addDriver($c, 'FOS\\UserBundle\\Entity');
        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('TestBundle' => 'TestBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_083760ea08ff0bf7c0afbf7b323ff85acec79a210b3001ce796a5b0b87efcf45');
        return $instance;
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Chef');
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Enseignant');
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Etudiant');
        ...
        $m->add($j, array(0 => 'ROLE_CHEF'), NULL);
        $m->add($k, array(0 => 'ROLE_ENSEIGNANT'), NULL);
        $m->add($l, array(0 => 'ROLE_ETUDIANT'), NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ISETKBundle/Resources/views'), 'ISETK');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_CHEF', 2 => 'ROLE_ENSEIGNANT', 3 => 'ROLE_ETUDIANT'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ISETKBundle' => 'ISETKBundle\\ISETKBundle',
            ),
