 ...
 */
class Classe extends \TestBundle\Entity\Classe implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'TestBundle\\Entity\\Classe' . "\0" . 'id', '' . "\0" . 'TestBundle\\Entity\\Classe' . "\0" . 'nom');
        }
