...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'isetk_homepage')), array (  '_controller' => 'ISETKBundle\\Controller\\DefaultController::indexAction',));
        }

        // isetk_home
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'isetk_home');
            }
        ...
        if (0 === strpos($pathinfo, '/Chef')) {
            // isetk_homeChef
            if ($pathinfo === '/Chef') {
                return array (  '_controller' => 'ISETKBundle\\Controller\\ChefController::indexAction',  '_route' => 'isetk_homeChef',);
            }

            // isetk_EmploiChef
            if ($pathinfo === '/Chef/Emploi') {
                return array (  '_controller' => 'ISETKBundle\\Controller\\ChefController::emploiAction',  '_route' => 'isetk_EmploiChef',);
            }

            // isetk_CompteChef
            if ($pathinfo === '/Chef/Compte') {
                return array (  '_controller' => 'ISETKBundle\\Controller\\ChefController::compteAction',  '_route' => 'isetk_CompteChef',);
            }

            if (0 === strpos($pathinfo, '/Chef/Absence')) {
                // isetk_AbsenceChef
                if ($pathinfo === '/Chef/Absence') {
                    return array (  '_controller' => 'ISETKBundle\\Controller\\ChefController::absenceAction',  '_route' => 'isetk_AbsenceChef',);
                }

                // isetk_doAbsenceChef
                if ($pathinfo === '/Chef/Absence') {
                    return array (  '_controller' => 'ISETKBundle\\Controller\\ChefController::doAbsenceAction',  '_route' => 'isetk_doAbsenceChef',);
                }

            }

            if (0 === strpos($pathinfo, '/Chef/Note')) {
                // isetk_NoteChef
                if ($pathinfo === '/Chef/Note') {
                    return array (  '_controller' => 'ISETKBundle\\Controller\\ChefController::noteAction',  '_route' => 'isetk_NoteChef',);
                }
        ...
        if (0 === strpos($pathinfo, '/E')) {
            if (0 === strpos($pathinfo, '/Enseignant')) {
                ...
                if ($pathinfo === '/Enseignant') {
                    return array (  '_controller' => 'ISETKBundle\\Controller\\EnseignantController::indexAction',  '_route' => 'isetk_homeEnseignant',);
                }

                // isetk_EmploiEnseignant
                if ($pathinfo === '/Enseignant/Emploi') {
                    return array (  '_controller' => 'ISETKBundle\\Controller\\EnseignantController::emploiAction',  '_route' => 'isetk_EmploiEnseignant',);
                }

                if (0 === strpos($pathinfo, '/Enseignant/Absence')) {
                    // isetk_AbsenceEnseignant
                    if ($pathinfo === '/Enseignant/Absence') {
                        return array (  '_controller' => 'ISETKBundle\\Controller\\EnseignantController::absenceAction',  '_route' => 'isetk_AbsenceEnseignant',);
                    }

                    // isetk_doAbsenceEnseignant
                    if ($pathinfo === '/Enseignant/Absence') {
                        return array (  '_controller' => 'ISETKBundle\\Controller\\EnseignantController::doAbsenceAction',  '_route' => 'isetk_doAbsenceEnseignant',);
                    }

                }

                if (0 === strpos($pathinfo, '/Enseignant/Note')) {
                    // isetk_NoteEnseignant
                    if ($pathinfo === '/Enseignant/Note') {
                        return array (  '_controller' => 'ISETKBundle\\Controller\\EnseignantController::noteAction',  '_route' => 'isetk_NoteEnseignant',);
                    }

                    // isetk_doNoteEnseignant
                    if ($pathinfo === '/Enseignant/NoteT') {
            ...
            if (0 === strpos($pathinfo, '/Etudiant')) {
                ...
                if ($pathinfo === '/Etudiant') {
                    return array (  '_controller' => 'ISETKBundle\\Controller\\EtudiantController::indexAction',  '_route' => 'isetk_homeEtudiant',);
                }

                // isetk_EmploiEtudiant
                if ($pathinfo === '/Etudiant/Emploi') {
                    return array (  '_controller' => 'ISETKBundle\\Controller\\EtudiantController::emploiAction',  '_route' => 'isetk_EmploiEtudiant',);
                }

                // isetk_ResultatEtudiant
                if ($pathinfo === '/Etudiant/Resultat') {
                    return array (  '_controller' => 'ISETKBundle\\Controller\\EtudiantController::resultatAction',  '_route' => 'isetk_ResultatEtudiant',);
                }

                // isetk_AbsenceEtudiant
                if ($pathinfo === '/Etudiant/Absence') {
                    return array (  '_controller' => 'ISETKBundle\\Controller\\EtudiantController::absenceAction',  '_route' => 'isetk_AbsenceEtudiant',);
                }
        ...
        // user_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_homepage')), array (  '_controller' => 'UserBundle:Default:index',));
        }
