...
class User extends \UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'emploi', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'Classe', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'Matiere', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
