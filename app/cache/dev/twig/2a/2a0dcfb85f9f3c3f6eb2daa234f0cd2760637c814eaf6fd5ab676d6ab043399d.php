...
/* ISETKBundle:Enseignant:Note.html.twig */
class __TwigTemplate_b4a41d00c884c7670bb4d62eaa7d8cc0fa7cf8cf09f30679dc723b00adc94b7d extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("ISETKBundle:Template:Template.html.twig", "ISETKBundle:Enseignant:Note.html.twig", 1);
        $this->blocks = array(
    ...
    <div class=\"section\">
        ...
        if (((isset($context["etudiants"]) ? $context["etudiants"] : $this->getContext($context, "etudiants")) != null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["e"]) {
                // line 58
                echo "                                            <form action=\"";
                echo $this->env->getExtension('routing')->getPath("isetk_doNoteEnseignant");
                echo "\">
                                            <TR> 
                                                <TD> ";
                // line 60
                ...
                echo " </TD> 
                                                <TD> <input type=\"text\" id=\"tp\" name=\"tp\" value=\"\" > </TD>
                                                <TD> <input type=\"text\" id=\"ds\" name=\"ds\" value=\"\"> </TD>
                                                <TD> <input type=\"text\" id=\"exam\" name=\"exam\" value=\"\"> </TD>
                                                <TD> 
...
";
    ...
    {
        return "ISETKBundle:Enseignant:Note.html.twig";
    }
    ...
    {
        return array (  158 => 84,  153 => 76,  147 => 72,  134 => 65,  124 => 60,  118 => 58,  114 => 57,  101 => 46,  99 => 45,  90 => 38,  75 => 36,  71 => 35,  66 => 33,  61 => 30,  52 => 21,  42 => 13,  39 => 12,  32 => 4,  29 => 3,  11 => 1,);
    }
}
...
/*                         <div class="col-sm-4">*/
/*                             <div class="icon-box">*/
/*                                 <form action="{{ path('isetk_NoteEnseignant') }}">*/
/*                                     <select id="cla" name="cla">*/
/*                                         {% for c in classes %}*/
...
/* */
/*                                         {% for e in etudiants %}*/
/*                                             <form action="{{ path('isetk_doNoteEnseignant') }}">*/
/*                                             <TR> */
