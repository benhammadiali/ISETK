...
/* ISETKBundle:Enseignant:Absence.html.twig */
class __TwigTemplate_560aae9bede0d8d92d7c837f50ff52b09e75b084c0de2b7b04dd70b227dfc0b6 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("ISETKBundle:Template:Template.html.twig", "ISETKBundle:Enseignant:Absence.html.twig", 1);
        $this->blocks = array(
    ...
    <div class=\"section\">
        ...
        if (((isset($context["etudiants"]) ? $context["etudiants"] : $this->getContext($context, "etudiants")) != null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["e"]) {
                // line 56
                echo "                                            <form action=\"";
                echo $this->env->getExtension('routing')->getPath("isetk_doAbsenceEnseignant");
                echo "\">
                                            <TR> 
                                                <TD> ";
                // line 58
...
";
    ...
    {
        return "ISETKBundle:Enseignant:Absence.html.twig";
    }
...
/*                         <div class="col-sm-4">*/
/*                             <div class="icon-box">*/
/*                                 <form action="{{ path('isetk_AbsenceEnseignant') }}">*/
/*                                     <select id="cla" name="cla">*/
/*                                         {% for c in classes %}*/
...
/* */
/*                                         {% for e in etudiants %}*/
/*                                             <form action="{{ path('isetk_doAbsenceEnseignant') }}">*/
/*                                             <TR> */
/*                                                 <TD> {{ e.prenom }} </TD> */
/*                                                 <TD> {{ e.nom }} </TD> */
/*                                                 <TD> */
